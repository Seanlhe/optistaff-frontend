...
const PreferencesMaximum: React.FC<PreferencesMaximumProps> = ({
  formData,
  setFormData,
}) => {
  ...
  const handleMaxHoursPerShiftChange = (
    e: React.ChangeEvent<HTMLInputElement>,
  ) => {
    const value = parseInt(e.target.value) || 0;
    setFormData({
  ...
  return (
    <div className="flex gap-8 mb-5 items-end">
      <div className="flex flex-col">
        <label className="block text-base font-semibold mb-2 text-main">
