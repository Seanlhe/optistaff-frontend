...
//                       <div className="text-base font-semibold text-primary-text">{template.template_name}</div>
              ...
              >
                ...
                <div className="flex gap-2">
                  <button
                    type="button"
                    onClick={() => onDelete(template.template_id)}
                    className="px-4 py-2 text-sm text-red-500 border border-red-400 rounded-md hover:bg-red-50 transition-colors"
                  >
                    Delete
                  </button>
                  <button
                    type="button"
                    onClick={() => onSelect(template.template_id)}
                    className="px-4 py-2 text-sm text-green-600 border border-green-500 rounded-md hover:bg-green-50 transition-colors"
                  >
                    Use
                  </button>
                </div>
