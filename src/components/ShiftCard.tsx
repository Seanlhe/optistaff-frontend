...
export default function ShiftCard({
  ...
  return (
    <div className="bg-white flex flex-row items-center justify-between rounded-2xl">
      <div className="w-full bg-white flex flex-col gap-3 rounded-2xl p-3">
        ...
        <div className="flex flex-row gap-2 items-center">
          <img
            className="w-4 h-4"
            src={`${shift.staff_assigned == shift.staff_needed ? "/public/icons/users.svg" : "/icons/userswarning.svg"}`}
          />
          <p
            className={`${shift.staff_assigned == shift.staff_needed ? "text-secondary-text font-montserrat" : "text-pink-500 font-montserrat-b"} text-xs`}
          >
        ...
        <button
          className="w-full hover:cursor-pointer hover:bg-gray-100 hover:opacity-80 bg-white rounded-md text-secondary-text py-2 px-3 border border-secondary-text font-montserrat-smb text-sm transition-colors"
