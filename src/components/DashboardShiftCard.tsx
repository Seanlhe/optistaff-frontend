...
export default function DashboardShiftCard({
  title,
  date,
  time,
  staffNo,
  ...
  return (
    <div className="bg-white flex flex-row p-5 items-center justify-between rounded-2xl">
      ...
      <button
        className="hover:cursor-pointer hover:bg-gray-100 hover: text-secondary-text hover:opacity-80 bg-white rounded-md text-secondary-text py-2.5 px-4 border border-secondary-text font-montserrat-smb text-lg"
