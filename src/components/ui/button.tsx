    ...
    return (
      <button
        className={cn(
          ...
          {
            "bg-primary-blue text-card-color hover:bg-primary-blue/90":
              variant === "default",
            "bg-red text-card-color hover:bg-red-dark":
              variant === "destructive",
            "border border-border bg-card-color hover:bg-secondary-bg hover:text-primary-text":
              variant === "outline",
            "bg-secondary-bg text-primary-text hover:bg-tertiary-bg":
              variant === "secondary",
