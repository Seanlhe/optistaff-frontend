        ...
        <div className="grid grid-cols-12 gap-y-4 gap-x-2 rounded-xl">
          ...
          <div className="col-span-3 flex flex-col">
            ...
            <input
              ...
              type="number"
              value={
                shiftObj.break_duration != null ? shiftObj.break_duration : 0
              }
              onChange={handleChange}
            />
          ...
          <div className="col-span-12 flex flex-col">
            ...
            <textarea
              ...
              value={
                shiftObj.job_description != null ? shiftObj.job_description : ""
              }
              onChange={handleChange}
            />
          ...
          <div className="col-span-12 flex flex-col">
            ...
            <textarea
              ...
              value={
                shiftObj.job_requirements != null
                  ? shiftObj.job_requirements
                  : ""
              }
              onChange={handleChange}
            />
