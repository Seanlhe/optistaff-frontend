  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">View and manage your job assignments</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-8 text-center">
        ...
        <p className="text-gray-600 mb-4">
          The My Jobs feature is currently under development. Here you'll be able to:
        </p>
        ...
        <div className="mt-6">
          <p className="text-sm text-gray-500">
            ...
            <a href="/employee/dashboard" className="text-blue-600 hover:text-blue-800 underline">
              Dashboard
            </a>{" "}
