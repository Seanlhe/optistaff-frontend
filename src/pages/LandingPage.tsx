...
export default function LandingPage() {
  const images: string[] = [
    "/images/capitaland.svg",
    "images/fourseasons.svg",
    "images/marriot.svg",
    "images/mercure.svg",
    "images/sats.svg",
    "images/tripdotcom.svg",
    "images/fourseasons.svg",
  ];
  ...
  return (
    <div id="landing-container" className="flex flex-col">
      <div
        id="landing-header"
        className="sticky top-0 z-50 pt-4 pb-4 px-37.5 bg-white flex flex-row justify-between items-center "
      >
        <img className="h-23" src="/images/optistafflogo.svg" />
        <div className="flex flex-row gap-15">
          <Link
            className="hover:underline font-montserrat text-lg text-primary-blue"
            to="/hire"
          >
            Employers
          </Link>
      ...
      <div id="landing-content" className="flex flex-col gap-43">
        <div
          ...
          className="flex flex-row justify-between py-12  px-37.5"
        >
          <div id="landing-tag" className="w-135 flex flex-col gap-12">
            <h1 className="font-montserrat-b text-5xl/20">
              Shifts that fit.
              <br /> Teams that Click.
            </h1>
            <p className="font-montserrat text-2xl/12">
              OptiStaff takes the hassle out of rostering for on-demand jobs by
        ...
        <div id="landing-brands" className="flex flex-col align-middle gap-12">
          <p className="text-center font-montserrat-b text-primary-blue text-4xl">
            Recognised by trusted brands
          </p>
          <div
            id="brands-carousell"
          ...
          >
            <div className="animate-slide inline-block whitespace-nowrap">
              {images.map((image: string) => {
                return <img className="mr-15 h-18 inline-block" src={image} />;
              })}
            </div>
            <div className="animate-slide inline-block whitespace-nowrap">
              {images.map((image: string) => {
        ...
        >
          <h2 className="col-span-2 text-center font-montserrat-b text-5xl text-black ">
            How do I get started?
          </h2>
          <div className="col-span-1 flex flex-col gap-10">
            <p className="font-montserrat-smb text-4xl">Create a job posting</p>
            <p className="font-montserrat text-2xl/10">
              Upload your job description and event details, including manpower
              needs, role breakdowns, venue, time and pay at least 1 week prior.
            </p>
          </div>
          <img
            className="col-span-1 w-full h-auto max-w-125"
          ...
          />
          <div className="col-span-1 flex flex-col gap-10">
            <p className="font-montserrat-smb text-4xl">
              Receive your employee allocations
            </p>
            <p className="font-montserrat text-2xl/10">
              Our system matches your jobs with available, qualified staff every
              Wednesday and Sunday at 8:30pm. <br /> <br /> In the event of
              cancellations, we will find suitable replacements.
            </p>
          </div>
          <div className="col-span-1 flex flex-col gap-10">
            <p className="font-montserrat-smb text-4xl">Execute and evaluate</p>
            <p className="font-montserrat text-2xl/10">
              Track staff attendance by scanning our in-app QR code. Afterwards,
              leave feedback on your staff so we can continuously improve your
              future matches.
            </p>
          </div>
          <img
        ...
        >
          ...
          <div className="relative col-span-1 flex flex-col gap-8 p-10 rounded-4xl rounded-bl-none bg-landing-bg">
            ...
            <p className="col-span-2 font-montserrat text-base/10">
              ...
              can balance earning an income while staying on top of my studies.
            </p>
          </div>
        </div>
        <div
          id="landing-second-cta"
          className="bg-landing-bg grid grid-cols-2 justify-items-start gap-x-50 gap-y-8.5 px-37.5 py-15"
        >
          <p className="text-justify font-montserrat-smb text-2xl">
            Ready to hire on-demand staff without all the hassle?
          </p>
          <p className="text-justify font-montserrat-smb text-2xl">
      ...
      <div
        id="landing-end"
        className="bg-white px-37.5 pt-15 pb-4 flex flex-row justify-between"
      >
        <p className="text-primary-blue text-xl font-montserrat">
          OptiStaff Pte Ltd © 2025
        </p>
        <div className="flex flex-row gap-33">
          <button className="hover:cursor-pointer hover:underline text-primary-blue text-l font-montserrat">
            Privacy Policy
          </button>
          <button className="hover:cursor-pointer hover:underline text-primary-blue text-l font-montserrat">
            Terms of Use
          ...
          <Link
            className="hover:cursor-pointer hover:underline text-primary-blue text-l font-montserrat"
            to="/contact"
          >
            Contact Us
          </Link>
