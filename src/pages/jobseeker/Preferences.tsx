    ...
    <div className="bg-zinc-50 dark:bg-zinc-900 min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-end mb-4">
          <button className="px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-zinc-900 transition-colors">
            Submit
          </button>
        </div>
