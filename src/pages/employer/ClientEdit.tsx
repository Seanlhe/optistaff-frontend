  ...
  return (
    <div id="upload-jobs-form" className="grow">
      <form className="grid grid-cols-6 gap-x-4 gap-y-8 items-center">
        <p className="pt-3 col-span-6 font-montserrat-b text-lg text-black">
        ...
        <CustomInputField
          ...
          name="address"
          title="Address"
          value={formData.job_location.split(" ").slice(0, -2).join(" ")}
          type="text"
          onChange={handleDataChange}
        />
        <CustomInputField
          ...
          name="zipCode"
          title="Zip Code"
          value={formData.job_location.split(" ").at(-1)}
          type="text"
          onChange={handleDataChange}
        />
        <p className="pt-3 col-span-6 font-montserrat-b text-lg text-black">
        ...
        <div
          id="upload-btns"
          className="col-span-6 flex flex-row gap-4 justify-end"
        >
          <button
            type="button"
...
function AssignmentsContainer({ shift }: { shift: Shift }) {
  return (
    <div className="w-116 min-h-screen flex flex-col gap-6 p-5 rounded-xl bg-secondary-bg ">
      ...
      <AssignmentsCard
        user={{ id: "12345", email: "seanleng", role: "employer" }}
      />
    </div>
  );
}
