  ...
  return (
    <div className="bg-tertiary-bg min-h-screen flex flex-col px-16 py-8 gap-10">
      <div className="flex flex-col gap-2">
        ...
        <p className="font-montserrat-smb text-base text-secondary-text">
          Modify details and click “save” to confirm
        </p>
      </div>
...
function UpdateForm({ shift, onClose }: { shift: Shift; onClose: Function }) {
  ...
  return (
    <div id="upload-jobs-form" className="w-2/3">
      <form className="grid grid-cols-12 gap-x-4 gap-y-12 items-center">
        <p className="pt-5 col-span-12 font-montserrat-b text-lg text-black">
        ...
        <CustomTextArea
          ...
          title="Description"
          value={shift.job_description != null ? shift.job_description : ""}
        ...
        <CustomTextArea
          ...
          title="Requirements"
          value={shift.job_requirements != null ? shift.job_requirements : ""}
        ...
        <CustomInputField
          ...
          title="Date"
          type="date"
          value={format(shift.start_time, "yyyy-MM-dd")}
        ...
        <CustomInputField
          ...
          title="Start Time"
          type="time"
          value={format(shift.start_time, "HH:mm")}
        ...
        <CustomInputField
          ...
          title="End Time"
          type="time"
          value={format(shift.end_time, "HH:mm")}
        ...
        <CustomInputField
          ...
          name="break_duration"
          title="Break (hrs)"
          value={shift.break_duration ? shift.break_duration : 0}
          type="number"
...
function AssignmentsContainer({ shift }: { shift: Shift }) {
  ...
  return (
    <div className="w-116 min-h-screen flex flex-col gap-6 p-5 rounded-lg bg-secondary-bg ">
      <p className="font-montserrat-b text-xl text-primary-text">
        Assigned Staff
      </p>
      {assignments?.map((a) => (
        <AssignmentsCard
...
function AssignmentsCard({
  ...
  return (
    <div className="w-full flex flex-row justify-between items-center bg-white p-5 rounded-lg">
      <div className="flex flex-row items-center gap-5">
        <img className="bg-[#D9D9D9] rounded-full w-15 h-15" src="" />
        <div className="flex flex-col gap-2">
          <p className="font-montserrat text-base text-primary-text">
            {assignment.employee_name}
          </p>
        </div>
      </div>
      <button
        onClick={() => handleContactClick(assignment)}
        className="hover:bg-gray-300 hover:cursor-pointer border-1 h-fit border-primary-text text-primary-text font-montserrat px-2 py-1 rounded-md"
      >
        Contact
      </button>
    </div>
...
function ContactCard({
  ...
  return (
    <div className="relative w-120 flex flex-col bg-white rounded-xl gap-5 p-5 shadow">
      <div className="flex flex-row items-center gap-5">
        <img className="bg-[#D9D9D9] rounded-full w-15 h-15" src="" />
        <p className="font-montserrat text-base text-primary-text">
          {assignment.employee_name}
      ...
      <div className="flex flex-col gap-3">
        <p className="font-montserrat-smb text-secondary-text">
          Email: {assignment.contact_email}
        </p>
        <p className="font-montserrat-smb text-secondary-text">
          Contact Number: {assignment.contact_number}
        </p>
      </div>
      <button
