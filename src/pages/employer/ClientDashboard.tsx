...
function DashboardPositions(){
    return <div className="bg-secondary-bg flex flex-row p-8 gap-13 rounded-3xl">
        <div className="flex flex-col gap-6">
            ...
            <p className="text-4xl font-montserrat-b text-primary-text">100/107 <span className="text-base font-montserrat text-primary-text">Filled</span></p>
        </div>
        <div>
            PieChart
        </div>
