...
function DashboardHeader(){
    return <div className="flex flex-row w-full justify-between">
            <div className="flex flex-col gap-2">
                ...
                <h1 className="text-4xl">Marriot Plaza</h1>
            </div>
...
function DashboardUpcoming({data}: {data: ShiftCardProps[]}){
    return <div className="bg-blue-300 grow flex flex-col p-8 rounded-3xl gap-8">
        <div className="flex flex-row gap-4 items-center">
            <img className="h-7 w-7"src="/public/icons/calendar.svg"/>
            <h1 className="text-3xl">Upcoming Shifts</h1>
        </div>
...
function DashboardPositions(){
    return <div className="bg-blue-300 flex flex-row p-8 gap-13 rounded-3xl">
        <div className="flex flex-col gap-6">
            <div className="flex flex-row gap-4 items-center">
                <img className = "h-7 w-7" src="/public/icons/personicon.svg"/>
                <h1 className="text-3xl">Positions</h1>
            </div>
            <p className="text-4xl">100/107 <span className="text-base">Filled</span></p>
        </div>
        <div>
            PieChart
        </div>
