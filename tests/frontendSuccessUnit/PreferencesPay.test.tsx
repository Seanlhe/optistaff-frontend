...
describe('PreferencesPay', () => {
  ...
  it('renders correctly with all elements', () => {
    ...
    expect(screen.getByRole('checkbox', { name: /consider me for a job with lower rate/i })).toBeTruthy();
  ...
  it('has correct label attributes', () => {
    ...
    expect(label.closest('label')?.getAttribute('for')).toBe('consider-lower-rate');
