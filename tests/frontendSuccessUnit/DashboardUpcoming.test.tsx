...
import { DashboardUpcoming } from '../../src/pages/employer/ClientDashboard';
...
describe("DashboardInProgress test suite", ()=>{
    ...
    it("No shifts are present", ()=>{
        render(<DashboardUpcoming shifts={[]} handleManageClick={handleManageClick}/>)
    ...
    it("More than 1 shifts are present", async ()=>{
        render(<DashboardUpcoming shifts={shifts} handleManageClick={handleManageClick}/>)
        const header = screen.getByText("This Week");
        expect(header).toBeTruthy();
