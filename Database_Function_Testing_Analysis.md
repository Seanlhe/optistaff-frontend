...
export const cleanupTestData = async () => {
  ...
  await testSupabase.from("feedback").delete().neq("feedback_id", "00000000-0000-0000-0000-000000000000");
  ...
  await testSupabase.from("availability").delete().neq("availability_id", "00000000-0000-0000-0000-000000000000");
  await testSupabase.from("preferences").delete().neq("preference_id", "00000000-0000-0000-0000-000000000000");
  await testSupabase.from("job_types").delete().neq("job_type_id", "00000000-0000-0000-0000-000000000000");
  await testSupabase.from("job_categories").delete().neq("category_id", "00000000-0000-0000-0000-000000000000");
  await testSupabase.from("job_seekers").delete().neq("user_id", "00000000-0000-0000-0000-000000000000");
  await testSupabase.from("clients").delete().neq("client_id", "00000000-0000-0000-0000-000000000000");
